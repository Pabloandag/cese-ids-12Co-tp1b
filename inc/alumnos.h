...
/**
 * @brief Convierte los datos de los alumnos presentes en el vector ALUMNOS en una cadena JSON
 * 
 * @param       cadena      Puntero a la cadena donde se devuelve el resultado
 * @param       espacio     Cantidad de bytes disponibles en la cadena de resultado
 * @return      true        Los datos fueron serializados correctamente
 * @return      false       No se pudieron serializar los datos
 */
